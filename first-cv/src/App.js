                ...
                <Row className="row-cols-1 " >
                    <Col className= "col-md-3 d-flex flex-column justify-content-center text-center mt-3 mb-3 ">
                        ...
                        <div className="  d-flex flex-row justify-content-center text-center ">
                            <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">samanthathee0908@gmail.com</Tooltip>}>
                            ...
                            <a className="linkedin" href="https://www.linkedin.com/in/samantha-theerawat-b59438100/"><FaLinkedin/></a>
                    ...
                    <Col className= "col-md-7 d-flex flex-column mb-3 ">
                        ...
                        <div className="mt-3">
                            ...
                            <h3> Utbildning och Certifiering i reguljära bokningssystem AMADEUS , Amadeus The Essentials, Foundation in Travel And Tourism</h3>
                        </div>
                        ...
                        <Row className=" d-flex mt-4 ">
                                ...
                                <Col className="mt-3">
                                    < h3 >1993 – 2000 <br/> Asiatiska restauranger, Göteborg <br/> Servitris/ Kokerska <br/>
                                        Jag tog restaurang jobb på flera olika restauranger och under denna period läser in behörighet till högskolan. </h3>
                                </Col>
                                <Col className="mt-3" >
